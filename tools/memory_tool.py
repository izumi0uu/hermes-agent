...
class MemoryStore:
    ...
    def __init__(self, memory_char_limit: int = 2200, user_char_limit: int = 1375):
        ...
        # Bind the profile-scoped memory directory once per store/session.
        # Callers may switch HERMES_HOME later in the same process (e.g. WebUI
        # profile changes), but this store must keep writing back to the
